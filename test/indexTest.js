describe("Formatter", () => {
  ...
  describe("titleize", () => {
    ...
    it("capitalizes all words in a sentence except 'the'", () => {
      ...
      expect(Formatter.titleize("chicken soup with rice and a few other songs")).to.equal(
        "Chicken Soup With Rice and a Few Other Songs"
      );
      expect(Formatter.titleize("Maurice a an but of and for at by from end")).to.equal(
